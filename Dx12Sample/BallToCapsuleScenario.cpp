...
void BallToCapsuleScenario::onLoad(CommandList& commandList)
{
	...
	auto particle = std::make_shared<PhysicsObject>(MeshType::Sphere, m_SphereMesh, m_customTexture);
	...
	auto capsule = std::make_shared<PhysicsObject>(MeshType::Capsule, m_CapsuleMesh, m_customTexture);
